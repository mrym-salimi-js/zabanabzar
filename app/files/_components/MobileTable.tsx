  ...
  return (
    <div className="w-full h-auto md:hidden flex flex-col gap-1.5 ">
      <div className="w-full h-auto flex flex-col p-2 gap-1.5 border-2 border-gray-300 rounded-3xl overflow-hidden ">
        {/* Header */}
        <div className="w-full h-10 flex p-2 items-center justify-between dark:bg-[var(--tertiary-dark)] rounded-xl border-b-2">
          <CardMoreActions />
          <GreenCheckBox />
        </div>
        ...
        <div className="w-full h-auto p-2 flex flex-row-reverse items-center justify-between">
          <div className="max-w-[150px]  flex flex-row-reverse items-center gap-2  dark:text-white">
            {/*File ext icon */}
